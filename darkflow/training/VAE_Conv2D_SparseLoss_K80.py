...
model_name = "VAE_Conv2D_SparseLoss_run2_K80_1EP"
num_epochs = 1
num_classes = 1
...
# save the scalers
dump(scaler_p, open(data_save_path + 'darkflow/models/K80/%s_particleScaler.pkl' %model_name, 'wb'))
dump(scaler_met, open(data_save_path + 'darkflow/models/K80/%s_metScaler.pkl' %model_name, 'wb'))
...
# Save the model
torch.save(model.state_dict(), data_save_path + 'darkflow/models/K80/%s.pt' %model_name)

# store training history
outFile = h5py.File(data_save_path + 'darkflow/models/K80/%s_Traininghistory.h5' %model_name, "w")
