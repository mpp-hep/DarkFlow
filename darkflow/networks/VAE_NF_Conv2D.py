...
class ConvNet(nn.Module):
        def __init__(self, args):
            ...
            #
            self.dense1 = nn.Linear(41,self.q_z_output_dim) #161 - full+met, 160-full, 41-4LJ
            ...
            self.dense4 = nn.Linear(self.q_z_output_dim, 41)
            self.dnn_bn4 = nn.BatchNorm1d(41)
            #
        ...
        def decode(self, z):
            ...
            out = out[:,:-1]
            # reshape
            out = out.view(out.size(0), 8, 5, 1) #20-full, 5-4LJ
            # DeConv
            out = self.p_x_nn(out)
